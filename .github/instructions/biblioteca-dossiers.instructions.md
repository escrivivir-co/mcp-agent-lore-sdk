---
description: "Use when Bot-Hilbert (cartógrafo, suite Scriptorium) entra a crear, extender o mantener un dossier de mapa dentro de la biblioteca de la sede (`dossier-<tema>-v00-<tag>/`). Activa las heurísticas de diseño ad hoc de biblioteca: formato literario consensuado, versionado, parsers pareja, señales de promoción a customizations."
applyTo: "dossier-**/**"
---
...
- Cuándo promover convención emergente a customization → [`general-definition.md#crecimiento-futuro-de-la-sede--señales-de-promoción`](../../general-definition.md#crecimiento-futuro-de-la-sede--señales-de-promoción)
- Frase brújula al editar un mapa: el cartógrafo **mantiene**, no glosa. Si el cuerpo del dossier empieza a opinar, revisar [`general-definition.md#axiomas-del-cartógrafo`](../../general-definition.md#axiomas-del-cartógrafo) y [`general-definition.md#important`](../../general-definition.md#important).
